...
<body onload="myFunction();" id="top-page">
    ...
    <div class="ad-banner py-4 w-75 mt-4 mx-auto d-flex justify-content-center align-items-center"
        style=" background-color: lightgray; border: 1px dashed gray;">
...
" style="text-align:center">
                    <div class="cover-ph"style="border-radius: 5px 50px 5px 50px  "> <img style="border-radius:20px "
                            src='uploads/partnerImages/<?php /* echo $row["partnerImage"];*/ ?>'alt='collabs partner at Alcryptonz'></div>
                </a>
            </div>
            <?php /* }  */ ?>
        </div>
...
while($row=mysqli_fetch_assoc($execez)){ 
    $v++; */
        ...
        <p style="text-align:center;color:green"><i class="fas fa-hand-point-left"></i> مرر يمينا او يسارا <i
                class="fas fa-hand-point-right"></i><br> لمشاهدة منشورات اخري </p>
    </div>
    </div>
    <!--End partners news -->
    ...
    <div class="page-wrapper"style="padding:10px;text-align:center;overflow:hidden !important">
        <div class="post-slider" style="margin-bottom:30px;">
            ...
            <p style="text-align:center;color:gray;padding:10px">Stay up to date with New posts related to
                Cryptocurrency.</p>
...
*/
    ...
    <div class="team d-none d-lg-block" id="te">
        <div class="container">
            <h3 style="text-align:center;padding:10px;margin-top:20px;"><i class="fas fa-clock"></i> &nbsp; Meet The
                Team</h3>
...
while($row=mysqli_fetch_assoc($execezz)){ */
            ...
            ?>
                <div class="swiper-slide">
                    <div class="text-center">
                        ...
                        <img src="uploads/teamImages/<?php /*echo $row["memberImage"]; */ ?>" class="rounded-circle img-fluid"
                            alt="Alcryptonz Team Member: <?php /*echo $row['memberName'];*/ ?>" style="max-width: 150px;">
    ...
    <!-- Banner Ad Placeholder -->
    <div class="ad-banner py-4 mb-4 d-flex justify-content-center align-items-center w-75 d-flex mx-auto"
        style=" background-color: lightgray; border: 1px dashed gray;">
        <!-- Ad Content Goes Here -->
        <p class='mt-3 text-center'>Banner Ad Placeholder (Your Ad Content Here)</p>
    </div>
